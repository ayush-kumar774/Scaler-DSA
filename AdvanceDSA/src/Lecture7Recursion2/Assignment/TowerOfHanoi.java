...
public class TowerOfHanoi {
    public static void main(String[] args) {
        int A = 2;
        int B = 3;
        ArrayList<ArrayList<Integer>> res = towerOfHanoi(A);
    ...
    public static ArrayList<ArrayList<Integer>> towerOfHanoi(int A) {
        ...
        towerOfHanoiRecursive(A, 1, 3, 2, moves);
        return moves;
    }
    private static void towerOfHanoiRecursive(int n, int start, int end, int aux, ArrayList<ArrayList<Integer>> moves) {
        if (n == 1) {
        ...
        towerOfHanoiRecursive(n - 1, start, aux, end, moves);
        ArrayList<Integer> move = new ArrayList<>();
        move.add(n);
        move.add(start);
        move.add(end);
        moves.add(move);
        towerOfHanoiRecursive(n - 1, aux, end, start, moves);
    }
}
/*
Problem Description
